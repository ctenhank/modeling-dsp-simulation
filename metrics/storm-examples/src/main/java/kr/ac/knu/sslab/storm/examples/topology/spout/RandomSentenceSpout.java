...
public class RandomSentenceSpout extends BaseRichSpout {
    ...
    private long sleepTimeMili;
    private int sleepTimeNano;
     ...
     */
    public RandomSentenceSpout(String outputDirectory, int dataSize, long sleepTimeMili, int sleepTimeNano) {
        this.sleepTimeMili = sleepTimeMili;
        this.sleepTimeNano = sleepTimeNano;
        ...
        //file = new File(Paths.get(outputDirectory, "source_latency.txt").toString());
    ...
    //public RandomSentenceSpout(String outputDirectory) {
    //    RandomSentenceSpout(outputDirectory, 100);
    //}
    ...
    public void nextTuple() {
        ...
        //if (sleepTimeMili != 0 && sleepTimeNano !=0 ){
        //try {
        //    Thread.sleep(sleepTimeMili, sleepTimeNano);
        //} catch (InterruptedException e) {
        //    e.printStackTrace();
        //}}

        // 500 Bytes setences
        final String sentence = setences[rand.nextInt(setences.length)];
