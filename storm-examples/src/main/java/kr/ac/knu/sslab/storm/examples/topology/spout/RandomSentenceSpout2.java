...
public class RandomSentenceSpout2 extends BaseRichSpout {
     ...
     */
    public RandomSentenceSpout2(String outputDirectory, int dataSize, int dataRate) {
        this.outputDirectory = outputDirectory;
        this.dataRate = dataRate;
        switch (dataSize) {
            case 250:
                sentences = RandomSentenceSpout2.sentences_250;
                break;
            case 500:
                sentences = RandomSentenceSpout2.sentences_500;
                break;
            case 1000:
                sentences = RandomSentenceSpout2.sentences_1000;
                break;
            case 1500:
                sentences = RandomSentenceSpout2.sentences_1500;
                break;
            default:
                sentences = RandomSentenceSpout2.sentences_100;
        }
    }
    ...
    public void close() {
        ...
        try {
            writer.append("SPOUT END: " + Long.toString(System.nanoTime()) + "\n");
            writer.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void open(Map<String, Object> conf, TopologyContext context, SpoutOutputCollector collector) {
        ...
        this.previousArrivalTime = System.nanoTime();
        ...
        String filename = "spout" + Integer.toString(this.taskId) + ".txt";
        file = new File(Paths.get(outputDirectory, filename).toString());
        try {
            writer = new BufferedWriter(new FileWriter(file, true));
            writer.append("SPOUT START: " + Long.toString(this.previousArrivalTime) + "\n");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
